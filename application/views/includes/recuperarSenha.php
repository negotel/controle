...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
        ...
        <p class="avisonome m-t-20">Olá, <strong class="cor2"><?php echo $result->nome; ?></strong>. <br>Clique no botão abaixo para redefinir a sua nova senha de acesso.</p></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td align="center"><a href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/login/codigo/'. rtrim(strtr(base64_encode($result->email), '+/', '-_'), '='); ?>" target="_blank" class="botao">Redefinir nova Senha</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
